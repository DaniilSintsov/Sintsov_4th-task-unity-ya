...
namespace Asteroids.Model
{
    ...
    {
        private readonly Timers<Simulation<Bullet>.PlacedEntity>
            _timers = new Timers<Simulation<Bullet>.PlacedEntity>();

        public void Simulate(Bullet bullet, Vector2 startPosition, Vector2 direction)
        {
            PlacedEntity placedEntity = null;
            var trajectory = new Trajectory(bullet.Speed, startPosition, direction,
                (_) => _timers.GetAccumulatedTime(placedEntity));
